sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.newGestionDInventairePoleEmploi.controller.CreerUnBien1", {
...
_onImagePress1: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("CreerUnBien2", oBindingContext, fnResolve, ""
		    );
		}.bind(this)).catch(function (err) { if (err !== undefined) { MessageBox.error(err.message); }});
...
onInit: function () {
        ...
        this.oRouter.getTarget("CreerUnBien1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
