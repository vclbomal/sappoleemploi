sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.newGestionDInventairePoleEmploi.controller.ReetiqueterUnBien", {
...
_onButtonPress17: function (oEvent) {
		...
		if (!oDialog) {
		    this.getOwnerComponent().runAsOwner(function () {
		oView = sap.ui.xmlview({viewName: "com.sap.build.standard.newGestionDInventairePoleEmploi.view." + sDialogName});
		        this.getView().addDependent(oView);
		        oView.getController().setRouter(this.oRouter);
...
onInit: function () {
        ...
        this.oRouter.getTarget("ReetiqueterUnBien").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
