sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("com.sap.build.standard.newGestionDInventairePoleEmploi.controller.ScannerUnBien", {
...
_onImagePress2: function (oEvent) {
		...
		return new Promise(function(fnResolve) {
		    ...
		    this.doNavigate("ReetiqueterUnBien", oBindingContext, fnResolve, ""
		    );
		}.bind(this)).catch(function (err) { if (err !== undefined) { MessageBox.error(err.message); }});
...
onInit: function () {
        ...
        this.oRouter.getTarget("ScannerUnBien").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
